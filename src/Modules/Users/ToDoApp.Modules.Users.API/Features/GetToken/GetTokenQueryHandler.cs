...
public class GetTokenQueryHandler : IRequestHandler<API.Features.GetToken.GetTokenQuery, string>
{
	...
	public async Task<string> Handle(API.Features.GetToken.GetTokenQuery request, CancellationToken cancellationToken)
	{
		string token = null;
